...
func main() {
	...
	// Contoh penggunaan GetProcessedElements jika diperlukan di tempat lain:
	// allElementsFromGetter := scraper.GetProcessedElements()
	// log.Printf("Data dari GetProcessedElements memiliki %d elemen.", len(allElementsFromGetter))
